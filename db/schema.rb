...
ActiveRecord::Schema.define(version: 2020_09_29_100141) do
  ...
  create_table "reservers", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["order_id"], name: "index_reservers_on_order_id"
  end
  ...
  add_foreign_key "reservers", "orders"
